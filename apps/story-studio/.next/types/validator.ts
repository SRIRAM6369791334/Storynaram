...
// Validate ../../src/app/workspace/stories/[id]/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/workspace/stories/[id]">> = Specific
  const handler = {} as typeof import("../../src/app/workspace/stories/[id]/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
